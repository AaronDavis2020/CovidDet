...
import torch
import sys
from solution.external.lungmask import utils
import SimpleITK as sitk
from solution.external.lungmask.resunet import UNet
import warnings
...
def get_model(modeltype, modelname):
    ...
    # state_dict = torch.hub.load_state_dict_from_url(model_url, progress=True, map_location=torch.device('cpu')) # from url
    state_dict = torch.load('unet_r231.pth') # from local
